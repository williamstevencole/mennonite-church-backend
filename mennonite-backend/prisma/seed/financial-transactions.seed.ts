...
const DEMO_TRANSACTIONS: FinancialTransactionSeed[] = [
  {
    categoryName: 'Diezmos y Ofrendas',
    categoryType: 'income',
    amount: 28500,
  ...
  },
  {
    ...
    amount: 4500,
    description: 'Pago de energía eléctrica enero',
  ...
  {
    categoryName: 'Ministerios',
    categoryType: 'expense',
    amount: 1800,
    description: 'Material didáctico para escuela dominical',
  ...
  {
    categoryName: 'Barbacoas',
    categoryType: 'income',
    amount: 15000,
    description: 'Recaudación de cena benéfica anual',
  ...
  },
  {
    ...
    categoryType: 'expense',
    amount: 6500,
    description: 'Transporte para conferencia de jóvenes',
