...
const DEMO_EVENTS: EventSeed[] = [
  {
    ...
    description: 'Servicio dominical de adoración, alabanza y predicación.',
  ...
  },
  {
    ...
    description: 'Estudio bíblico por grupos antes del culto.',
    location: 'Aulas',
  ...
  },
  {
    ...
    description: 'Reunión semanal de oración intercesora.',
    location: 'Salón de oración',
    eventTypeName: 'Reunión Ministerial',
    isRecurrent: true,
    frequency: 'weekly',
    dayOfWeek: 'Wednesday',
  ...
  },
  {
    ...
    description: 'Conferencia anual para jóvenes de la iglesia.',
    location: 'Templo principal',
    eventTypeName: 'Actividad Especial',
